...
export default function MetricCard({ title, value, subtitle, trend, trendPositive, icon, chart }: MetricCardProps) {
  const data = chartData[chart as keyof typeof chartData]
